...
a = addon.get_addon("script.module.tinyxbmc")
addon_dir = xbmc.translatePath(a.getAddonInfo('path'))


class cInputWindow(xbmcgui.WindowDialog):
    def __init__(self, *args, **kwargs):
        bg_image = os.path.join(addon_dir, 'resources', 'DialogBack2.png')
        check_image = os.path.join(addon_dir, 'resources', 'checked.png')
        check_image2 = os.path.join(addon_dir, 'resources', 'checked_overlay.png')
        ...
        self.strSiteInfo = xbmcgui.ControlLabel(imgX, imgY - 40, imgw, 20, kwargs.get('sitemsg'), 'font13')
        self.strActionInfo = xbmcgui.ControlLabel(imgX, imgY - 25, imgw, 20, self.msg, 'font13')
        ...
        for i in xrange(9):
            ...
            self.chkbutton[i] = xbmcgui.ControlButton(x_pos, y_pos, pw, ph, str(i + 1),
                                                      noFocusTexture='0x00000000',
